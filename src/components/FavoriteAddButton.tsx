...
import { getStrokeColor } from '../utils/stroke_color_handler'

const StarIcon = ({ fill = getStrokeColor(), checked = false }) =>
  <>
    <svg
      width='20px' height='auto' viewBox='0 0 24.00 24.00' fill={checked ? fill : 'none'}
    ...
    >
      ...
      <g id='SVGRepo_iconCarrier'>
        <path
          ...
          stroke={fill} stroke-width='2.4' stroke-linecap='round' stroke-linejoin='round'
        />
      </g>
    </svg>
  </>
...
export function FavoritesButtonPortal ({ tg }: { tg: Element | undefined }): React.ReactNode {
  ...
  div.id = 'chzzk-pip-favorites-add-button'
